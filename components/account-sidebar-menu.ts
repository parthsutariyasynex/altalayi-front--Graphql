...
export const accountSidebarMenu: AccountSidebarItem[] = [
    { name: "My Account", nameKey: "sidebar.myAccount", href: "/customer/account" },
    ...
    { name: "My Orders", nameKey: "sidebar.myOrders", href: "/sales/order/history" },
    { name: "My Order Attachments", nameKey: "sidebar.myOrderAttachments", href: "/customer/order-attachments" },
    { name: "Favorite Products", nameKey: "sidebar.favoriteProducts", href: "/wishlist" },
    { name: "Address Book", nameKey: "sidebar.addressBook", href: "/customer/address" },
