...
const MultiShippingReviewPage: React.FC = () => {
    ...
    if (isLoading || isCartLoading || isCheckoutLoading) {
        return <MultiLocationReviewSkeleton groups={1} />;
    }
    ...
    return (
        <div className="bg-white min-h-screen font-sans pb-10 md:pb-20">
            <div className="max-w-[1240px] mx-auto pt-6 md:pt-10 px-3 sm:px-4">
                    ...
                    <div className="flex flex-col bg-[#f7f7f7] border border-gray-100">
                        ...
                        <div className="p-5 md:p-8 space-y-4 md:space-y-6">
                            <div className="text-center">
                                <p className="text-[13px] md:text-[14px] font-bold text-black uppercase tracking-tight">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <p className="text-[11px] font-bold text-black uppercase tracking-widest mb-2">{t("multi.paymentCommitment")}</p>
                                ...
                                <div>
                                    <p className="text-[11px] font-bold text-black uppercase tracking-widest mb-2">{t("multi.leaveComment")}</p>
                                    <textarea
                ...
                <h3 className="text-[17px] sm:text-[18px] md:text-[20px] font-bold text-black text-center mb-4 uppercase tracking-tighter">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 md:gap-4">
                                ...
                                <div className="flex flex-col bg-[#f7f7f7]">
                                    ...
                                    <div className="p-5 md:p-8 space-y-4 md:space-y-6 flex-grow">
                                        <div>
                                            <p className="text-[11px] font-bold text-black uppercase mb-2">{t("multi.poNumber")}</p>
                                            <input
                                                type="text"
                                        ...
                                        <div>
                                            <p className="text-[11px] font-bold text-black uppercase mb-2">{t("multi.uploadPo")}</p>
                                        ...
                                        <div>
                                            <p className="text-[11px] font-bold text-black uppercase mb-2">{t("multi.orderComment")}</p>
                                            <textarea
                                        ...
                                        <table className="w-full text-left border-collapse">
                                            <thead>
                                                <tr className="border-b border-transparent">
                                                    <th className="py-3 md:py-4 px-2 md:px-4 text-[10px] md:text-[12px] font-bold text-black uppercase">{t("item")}</th>
                                                    <th className="py-3 md:py-4 px-2 md:px-3 text-[10px] md:text-[12px] font-bold text-black uppercase text-right">{t("price")}</th>
                                                    <th className="py-3 md:py-4 px-2 md:px-3 text-[10px] md:text-[12px] font-bold text-black uppercase text-center">{t("qty")}</th>
                                                    <th className="py-3 md:py-4 px-2 md:px-4 text-[10px] md:text-[12px] font-bold text-black uppercase text-right">{t("total")}</th>
                                                </tr>
                                            </thead>
                                            <tbody className="bg-transparent">
                                                {group.items.map((item) => (
                                                    <tr key={item.itemId}>
                                                        ...
                                                        <td className="py-3 md:py-4 px-2 md:px-3 text-[11px] md:text-[13px] font-bold text-black text-right align-top whitespace-nowrap">
                                                            <Price amount={item.price} />
                                                        </td>
                                                        <td className="py-3 md:py-4 px-2 md:px-3 text-[11px] md:text-[13px] font-bold text-black text-center align-top">
                                                            {item.qty}
                                                        </td>
                                                        <td className="py-3 md:py-4 px-2 md:px-4 text-[11px] md:text-[13px] font-bold text-black text-right align-top whitespace-nowrap">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td className="py-2 px-2 md:px-4 text-right text-[10px] md:text-[12px] font-bold text-black whitespace-nowrap"><Price amount={itemTotal} /></td>
                                                </tr>
                                                <tr>
                                                    <td colSpan={3} className="py-2 px-2 md:px-4 text-right text-[10px] md:text-[12px] font-[900] text-black uppercase">{t("multi.vat")}</td>
                                                    <td className="py-2 px-2 md:px-4 text-right text-[10px] md:text-[12px] font-bold text-black whitespace-nowrap"><Price amount={vat} /></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td className="py-4 md:py-6 px-2 md:px-4 text-right text-[11px] md:text-[14px] font-bold text-black whitespace-nowrap"><Price amount={groupTotal} /></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                ...
                <div className="mt-8 md:mt-12 mb-6 md:mb-8 flex justify-center md:justify-end">
                    <p className="text-[16px] sm:text-[18px] md:text-[20px] font-bold text-black uppercase">
                ...
                <div className="bg-[#f2f2f2] p-4 sm:p-6 md:p-8 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
                    <button
                        ...
                        className="w-full sm:w-auto bg-black text-white px-6 md:px-10 py-3.5 md:py-4 text-[11px] font-bold uppercase tracking-[0.15em] hover:opacity-90 transition-opacity text-center"
                    >
